...
const CURRENCY_CODES =
    "USD|EUR|Euro|RM|WON|PH|Rupee IN|AUD|SEK|CHF|NOK|R|Yen|AU|BR|UK|CAD|HUF|CZK|TL|AT|RON|Pound|NZD|Rp|EU|Twd|MYR|GBP|HKD|KW|RUB|Baht|PLN|TRY|CNY|JPY|INR|KZT|UZS|AZN|GEL|KGS|TJS|UAH|BYN|AMD|SGD|THB|IDR|PHP|VND|BRL|MXN|ARS|CLP|COP|PEN|AED|SAR|QAR|KWD|BHD|OMR|IRR|EGP|ZAR|NGN|KES|GHS";
