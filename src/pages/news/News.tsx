                ...
                <div className="max-w-255 m-auto">
                    <div className="text-[15.67px] font-medium flex items-center gap-3.5">
                        <Link to="/" className="flex items-center gap-1 w-fit text-[#969FA8]">
                            <img src="/partner/grid.webp" alt="grid" style={{ width: 24 }} loading="lazy" />
                            <span>{t.news.home}</span>
                            <img src="partner/arrow.webp" alt="arrow" style={{ width: 24 }} loading="lazy" />
                        </Link>
                    ...
                    <img src="home/news/1.webp" alt="news" className="w-full rounded-3xl" loading="lazy" />
